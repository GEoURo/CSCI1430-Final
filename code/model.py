...
class NeRF(nn.Module):
    def __init__(self, numLayerPosition=8, numLayerColor=1,
                 ...
                 numPositionEmbeddingFunctions=10, numDirectionEmbeddingFunctions=4, useLogScale=True):
        super(NeRF, self).__init__()

        # create positional and directional encoding
        self.positionEncoder, positionEncodingDim = getEncoder(numPositionEmbeddingFunctions, useLogScale)
        self.directionEncoder, directionEncodingDim = getEncoder(numDirectionEmbeddingFunctions, useLogScale)
