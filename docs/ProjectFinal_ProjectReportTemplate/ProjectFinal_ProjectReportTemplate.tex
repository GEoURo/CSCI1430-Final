...
\begin{enumerate}
    ...
    \item Length: Approximately four pages for techical description. For social impact and the five critique points, a short paragraph for each and no more than one page total.
